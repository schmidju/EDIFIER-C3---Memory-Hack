...
#define i2c_buffer_size 8// I2C_REG_ANZAHL 254 Hier kann eingestellt werden wieviele Register ausgegeben werden
...
*/
volatile uint8_t i2cpackage[i2c_buffer_size];
